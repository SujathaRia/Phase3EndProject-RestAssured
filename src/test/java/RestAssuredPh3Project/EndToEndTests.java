package RestAssuredPh3Project;
			...
			public class EndToEndTests {
			    ...
			    public void testEndToEnd() {
			        ...
			        Response response = reusableMethods.getAllEmployees();
			        ...
			        response = reusableMethods.getAllEmployees();
			        Assert.assertEquals(response.getStatusCode(), 200);
			        jsonPath = response.jsonPath();
			        ...
			        response = reusableMethods.getSingleEmployee(employeeId);
			        Assert.assertEquals(response.getStatusCode(), 200);
			        jsonPath = response.jsonPath();
			        Assert.assertEquals(jsonPath.getString("firstName"), "Tom");
